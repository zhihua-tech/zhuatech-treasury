...
class CounterpartyConcentrationServiceTests {private final CounterpartyConcentrationService service=new CounterpartyConcentrationService();
  ...
  * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
  */
 @Test void acceptsBalancedPortfolio(){var r=service.evaluate(new CounterpartyConcentrationService.Request(b("1000"),b("300"),b("0"),"AA",b("200"),b("100")));assertEquals("BALANCED",r.status());}/**
                                                                                                                                                                                                    * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
                                                                                                                                                                                                    */
